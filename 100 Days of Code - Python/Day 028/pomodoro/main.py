...
"""
if you only using usibg this particular file copy and change the ralative path of the sound alarm and the image
"""
...
pygame.mixer.init()
def play_music():
    pygame.mixer.music.load("Day 028/pomodoro/Alarm-Fast-High-Pitch-A1-www.fesliyanstudios.com.mp3")
...
img = tk.PhotoImage(file = "Day 028/pomodoro/PngItem_947459.png")
